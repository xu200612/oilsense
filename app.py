...
# ══════════════════════════════════════════════════════════════════════════
    ...
    st.title("油价风险因子分析")
    st.caption("基于多维因子的油价波动驱动分析与风险量化 · 第一层 XGBoost 分位数回归 + 第二层历史情景匹配")
...
# ══════════════════════════════════════════════════════════════════════════
    ...
    CRISIS_EVENTS = [
        ...
        {"date": "2026-03-02", "label": "霍尔木兹封锁",  "color": "#e74c3c",
         "logic": "美以空袭伊朗（2026-02-28）→ IRGC于3月2日正式关闭霍尔木兹海峡 → WTI从$71飙至$114 → 第二层极端情景自动激活"},
    ]
    ...
    event_map = {
        "霍尔木兹封锁(2026-03-02)": ("2026-03-02", "#e74c3c"),
